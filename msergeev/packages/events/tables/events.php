...
class EventsTable extends DataManager {
	...
	public static function getMap() {
		return array(
			...
			new Entity\IntegerField('TYPES_ID',array(
				'required' => true,
				'link' => 'ms_events_types.ID',
				'title' => 'ID типа события'
			)),
			new Entity\IntegerField('USER_ID',array(
				'required' => true,
				'default_value' => 0,
				'title' => 'ID пользователя события'
			))
		);
	}
}